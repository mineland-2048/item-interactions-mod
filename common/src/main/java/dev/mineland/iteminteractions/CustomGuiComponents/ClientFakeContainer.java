package dev.mineland.iteminteractions.CustomGuiComponents;
...
//            guiGraphics.drawString(Minecraft.getInstance().font, "x: " + slot.x)
    ...
    public void printItemStacks() {
        ItemInteractions.infoMessage(itemStacks.toString());
    }
...
//        ItemInteractions.infoMessage("removeItem(" + i + ", " + j + ")");
...
//        ItemInteractions.infoMessage("removeItemNoUpdate(" + i + ")");
...
//        ItemInteractions.infoMessage("setItem(" + i + ", " + itemStack.toString() + ")");
...
//        ItemInteractions.infoMessage("setChanged()");
    }

    @Override
    public boolean stillValid(Player player) {
//        ItemInteractions.infoMessage("stillValid() called oh no");
...
//        ItemInteractions.infoMessage("clearContent()");
...
//        ItemInteractions.infoMessage("slotX: " + slotX + ", slotY: " + slotY + ", id: " + slotId);

        mouseClicked(slotId, mouseButton);
//        ItemInteractions.infoMessage(");
//        int id =
    }
...
//                    ItemInteractions.infoMessage("taking!");
...
//                yesMouse
//
//                ItemInteractions.infoMessage("Safe inserting!");
