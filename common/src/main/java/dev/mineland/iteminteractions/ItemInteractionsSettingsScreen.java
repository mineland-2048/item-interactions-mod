...
public class ItemInteractionsSettingsScreen extends Screen {
    ...
    private CycleButton<ItemInteractions.animation> animationCycleButton;
    ...
    ItemInteractions.animation oldAnimationConfig = ItemInteractionsConfig.animationConfig;
...
//    public static double mouseSpeedMult = 1;
    ...
    public ItemInteractionsSettingsScreen(Screen parent){
        ...
        this.parent = parent;
//        ItemInteractions.infoMessage("Created screen");
    ...
    void createLayout() {
        ...
        animationCycleButton = leftColumnLayout.addChild(
                CycleButton.<ItemInteractions.animation>builder(animationSetting ->
                                animationSetting.component.copy().withStyle(
                                        animationSetting == ItemInteractions.animation.NONE ?
                                                ChatFormatting.RED : ChatFormatting.YELLOW)
                        )
                        .withValues(
                                ItemInteractions.animation.ANIM_SPEED,
                                ItemInteractions.animation.ANIM_SCALE,
                                ItemInteractions.animation.NONE)
...
//        ItemInteractions.infoMessage("Exiting item screen");
